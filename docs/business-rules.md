...
- Mensagens permitem resposta citada e reação rápida do canal. Essas ações exigem permissão de resposta e acesso à conversa; reações do contato e do celular também são refletidas quando o provider as entregar.
...
- A ação `Conversar` em Membros abre a conversa vinculada mais recente dentro do escopo do operador. Quando ainda não existe uma conversa acessível, o sistema direciona ao perfil para iniciar uma nova, que continua sujeita ao consentimento do membro.
