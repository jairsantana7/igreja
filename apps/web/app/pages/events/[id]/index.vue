...
interface Registration {
  ...
  pixPaymentDeclaredAt: string | null; pixPaymentAmountCents: number | null;
...
const canCreateGallery = computed(() => permissions.value.includes('galleries.create'));
...
const feedback = ref(route.query.created === '1' ? 'Evento criado. O link e o QR Code já estão prontos para compartilhar.' : '');
