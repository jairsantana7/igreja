...
const form = reactive({ title: '', description: '', location: '', startsAt: '', registrationDeadline: '', capacity: undefined as number | undefined, mediaDisplayMode: 'hero' as ManagedEvent['mediaDisplayMode'], fields: [] as any[] });
