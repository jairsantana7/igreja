...
const form = reactive({ title: '', description: '', location: '', startsAt: '', registrationDeadline: '', capacity: undefined as number | undefined, mediaDisplayMode: 'hero' as 'hero' | 'carousel' | 'fixed', familyRegistrationEnabled: false, publish: true, fields: [] as any[], offerings: [] as any[] });
